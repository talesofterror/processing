...
public class square_icons extends PApplet {
...
public float sine (float freq, float amp) {
...
public void saveFrames (int numberOfFrames) {
...
class pixelscanner {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "square_icons" };
    if (passedArgs != null) {
